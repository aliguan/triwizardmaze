...
function typeRiddle() {
        ...
        $(".riddle").typed({
            strings: ["First think of the person who lives in disguise,<br>" + "Who deals in secrets and tells naught but lies.<br> ^1200", "Next, tell me what's always the last thing to mend,<br>" + "The middle of the middle and the end of the end? ^1200","And finally give me the sound often heard,<br> During the search for a hard-to-find word. ^1200", "Now string them together, and answer me this,<br> Which creature would you be unwilling to kiss? ^1200"],
